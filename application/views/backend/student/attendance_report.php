            ...
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive">
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for="example-text"><?php echo get_phrase('select_department');?></label>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <select id="year" class="form-control">
                                <?php
                                    ...
                                    // Generate a range of years from start_year to current_year
                                    $list_year = range($current_year, $start_year, );
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-info btn-rounded btn-block btn-sm" id="find">
                            <i class="fa fa-search"></i>&nbsp;<?php echo get_phrase('get_attendance');?>
                        </button>
                    </div>
                </div>
            </div>
