                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select name="class_id"  class="form-control select2" onchange="show_students(this.value)">
                                        ...
                                        <option value="<?php echo $class['class_id'];?>"<?php if($class_id == $class['class_id']) echo 'selected="selected"' ;?>>Department: <?php echo $class['name'];?></option>
                                        <?php endforeach;?>
                                </select>
    					...
    					<table cellpadding="0" cellspacing="0" border="0" class="table">
								<thead>
									<tr>
										...
										<td><?php echo get_phrase('CET-1');?></td>
										<td><?php echo get_phrase('CET-2');?></td>
           ...
           ?>
			...
			<?php echo form_open(base_url() . 'admin/marks/'. $exam_id . '/' . $class_id);?>
						<tr>
											...
											<td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['CET-1'];?>" name="CET-1_<?php echo $class_subject_exam_student['subject_id'];?>" readonly>
											</td>
											  <td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['CET-2'];?>" name="CET-2_<?php echo $class_subject_exam_student['subject_id'];?>" readonly>
											</td>
											  <td>
												<input type="number" class="exam_score form-control" value="<?php echo $general_select['exam_score'];?>" name="exam_score_<?php echo $class_subject_exam_student['subject_id'];?>" readonly>
											</td>
			
											<td>
												<textarea name="comment_<?php echo $class_subject_exam_student['subject_id'];?>" class="form-control" readonly><?php echo $general_select['comment'];?></textarea>
											</td>
