    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('invoices');?>
            </div>
                ...
                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><div><?php echo get_phrase('actions');?></div></th><!-- Add this column for payment option -->
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description;?><?php echo number_format($row['amount_paid'],2,".",",");?>
                            </td> 
                            <td>
                            ...
                            <!-- Add payment option column -->
                            <td>
                                <?php if($row['due'] > 0 && $row['status'] == 'pending'):?>
                                    <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#paymentModal_<?php echo $row['invoice_id'];?>"><?php echo get_phrase('make_payment');?></a>
                                <?php endif;?>
                            </td>
                        </tr>
                        <?php endforeach;?>
