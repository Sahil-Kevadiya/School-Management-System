...
<div class="navbar-default sidebar" role="navigation">
    ...
    <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-book p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('Academics');?><span class="fa arrow"></span></span></a>
        ...
        <li class="<?php if ($page_name == 'attendance' || $page_name == 'marks') echo 'active'; ?>">
        <a href="#" class="waves-effect">
            <i class="fa fa-list-alt p-r-10"></i>
            <span class="hide-menu"><?php echo get_phrase('Student Information'); ?><span class="fa arrow"></span></span>
        </a>
        <ul class="nav nav-second-level">
            ...
            <li class="<?php if ($page_name == 'marks') echo 'active'; ?> ">
                        ...
                        <i class="fa fa-angle-double-right p-r-10"></i>
                           <span class="hide-menu"><?php echo get_phrase('Marks'); ?></span>
                        </a>
                    </li>
        </ul>
    </li>
