           ...
           ?>
			...
			<?php echo form_open(base_url() . 'admin/student_marksheet_subject/'. $exam_id . '/' . $class_id);?>
						<tr>
											...
											<td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['CET-1'];?>" name="CET-1_<?php echo $student_selected_with_class['student_id'];?>" onchange="class_score_change()">
											</td>
											  <td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['CET-2'];?>" name="CET-2_<?php echo $student_selected_with_class['student_id'];?>" onchange="class_score_change()">
											</td>
											  <td>
