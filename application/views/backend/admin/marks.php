           ...
           ?>
			...
			<?php echo form_open(base_url() . 'admin/marks/'. $exam_id . '/' . $class_id);?>
						<tr>
											...
											<td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['CET-1'];?>" name="CET-1_<?php echo $class_subject_exam_student['subject_id'];?>" onchange="class_score_change()">
											</td>
											  <td>
												<input type="number" class="class_score form-control" value="<?php echo $general_select['CET-2'];?>" name="CET-2_<?php echo $class_subject_exam_student['subject_id'];?>" onchange="class_score_change()">
											</td>
											  <td>
