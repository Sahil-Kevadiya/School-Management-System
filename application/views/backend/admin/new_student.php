...
<div class="panel panel-info">
		...
		<a href="<?php echo base_url();?>admin/classes/"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-plus"></i></button></a>
					...
					<div class="form-group">
                 	<label class="col-md-9" for="example-text"><?php echo get_phrase('class');?></label>
                    <div class="col-sm-12">
	...
	<a href="<?php echo base_url();?>admin/section/"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-plus"></i></button></a>
			...
			<div class="form-group">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-12">
							<input type="date" value="<?php echo date('Y-m-d'); ?>" id="example-date-input" class="form-control datepicker" name="date_of_leaving">
                    ...
                    <div class="col-sm-12">
							<input type="date" value="<?php echo date('Y-m-d'); ?>" id="example-date-input" class="form-control datepicker" name="am_date">
