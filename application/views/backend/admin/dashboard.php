                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4 class="count"><?php echo $this->db->count_all_results('assignment');?></h4>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                $expense_amount = $query->row()->amount;?>
                                    <h4><?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description;?></h4>
                                    <h4 class="count"><?php echo $expense_amount;?></h4>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                $income_amount = $query->row()->amount; ?>
                                    <h4><?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description;?></h4>
                                    <h4 class="count"><?php echo $income_amount;?></h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4 class="count"><?php echo $this->db->count_all_results('admin');?></h4>
