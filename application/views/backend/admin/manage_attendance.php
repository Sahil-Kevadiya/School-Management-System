...
<!----CREATION FORM STARTS---->
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="date" class="form-control datepicker" id="example-date-input" name="timestamp" data-format="dd-mm-yyyy" value="<?php echo date('Y-m-d'); ?>" required>
                    </div>
                </div>
            ...
            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                    ...
                    <?php $students = $this->db->get_where('student', array('class_id' => $class_id))->result_array();
                        ...
                        <tr class="gradeA">
                            ...
                            <option value="2"<?php if($status == 0) echo 'selected="selected"';?>>Absent</option>
